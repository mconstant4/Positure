...
import uri.egr.biosensing.positure.GattAttributes.GattDescriptors;
import uri.egr.biosensing.positure.GattAttributes.GattDevices;
...
public class BluetoothLeService extends Service {
    ...
    private static final String DEBUG_LOG_TAG = BluetoothLeService.class.getSimpleName();
    ...
    public boolean connect() {
        ...
        BluetoothDevice bluetoothDevice = mBluetoothAdapter.getRemoteDevice(GattDevices.POSITURE_DEVICE);
        ...
        log("Establishing connection to " + GattDevices.POSITURE_DEVICE + "...");
        return true;
    }
    ...
    public boolean disconnect() {
        ...
        BluetoothGatt bluetoothGatt = mBluetoothGattList.get(GattDevices.POSITURE_DEVICE);
        if (bluetoothGatt == null) {
        ...
        log("Disconnecting from " + GattDevices.POSITURE_DEVICE + "...");
        return true;
    }
